...
Additionally, I ran into significant difficulties building my style model. My first iteration of the model with 19 classes had a maximum of 27% accuracy across different epochs, training rates, and input shapes. The model is also very computationally expensive and takes roughly 30 minutes to run on my macbook. With the merged class data, model performance still remains below what I initially exspected, but results still reflect a meaningful stylistic understanding.
